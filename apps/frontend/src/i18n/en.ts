export const en = {
  ...
  feedback: {
    open: 'Send feedback',
    kicker: 'Feedback',
    heading: 'Help improve MediaShelf',
    description:
      'Report a bug or suggest an improvement. You can submit without signing in.',
    kind: 'What would you like to share?',
    bugTitle: 'Report a bug',
    bugBody:
      'Something is broken, looks wrong, or did not work as you expected.',
    improvementTitle: 'Suggest an improvement',
    improvementBody:
      'An idea that would make the app more useful or easier to use.',
    summary: 'Summary',
    details: 'Details',
    email: 'Email',
    emailOptional: '(optional)',
    emailHint: 'So we can follow up. Leave blank if you prefer not to.',
