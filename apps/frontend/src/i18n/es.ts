...
export const es: Messages = {
  ...
  feedback: {
    ...
    kicker: 'Comentarios',
    heading: 'Ayuda a mejorar MediaShelf',
    description:
      'Informa de un error o sugiere una mejora. Puedes enviarlo sin iniciar sesión.',
    kind: '¿Qué quieres compartir?',
    bugTitle: 'Informar de un error',
    bugBody: 'Algo no funciona, se ve mal, o no es lo que esperabas.',
    improvementTitle: 'Sugerir una mejora',
    improvementBody:
      'Una idea para que la app sea más útil o más fácil de usar.',
    summary: 'Resumen',
    details: 'Detalles',
    email: 'Correo',
    emailOptional: '(opcional)',
    emailHint:
      'Para poder responderte. Déjalo en blanco si prefieres no darlo.',
    submit: 'Enviar comentarios',
    submitting: 'Enviando…',
    sent: 'Gracias — se enviaron tus comentarios.',
    sendAnother: 'Enviar otros',
    summaryRequired: 'El resumen es obligatorio',
    detailsRequired: 'Los detalles son obligatorios',
    emailInvalid: 'Introduce un correo válido, o déjalo en blanco',
    submitFailed: 'No se pudieron enviar los comentarios',
    inboxHeading: 'Bandeja',
